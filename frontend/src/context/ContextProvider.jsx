...
export const ContextProvider = ({ children }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      options: [
        { id: "tutoria1", label: "Registrar tutoría" },
        { id: "tutoria2", label: "Listado" },
        { id: "tutoria3", label: "Reportes" },
      ],
    },
    {
      name: "Representantes",
    ...
    },
    {
      ...
      options: [
        ...
        { id: "confi3", label: "Crear paralelo" },
      ],
    },
  ];
