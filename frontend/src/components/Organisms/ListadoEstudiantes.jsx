...
const ListadoEstudiantes = () => {
  ...
  const representanteBodyTemplate = (rowData) => {
    return rowData.id_user_FK ? <span className="text-gray-800 font-medium">{rowData.id_representante_FK.id_user_FK.full_name}</span> : "No disponible";
  };
        ...
        <div>
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            >
              ...
              <Column header="Representante" body={representanteBodyTemplate} />
