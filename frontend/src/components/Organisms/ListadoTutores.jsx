...
const ListadoTutores = () => {
    ...
    useEffect(() => {
        axios.get('http://127.0.0.1:8000/api/v1/tutor/listado/')
        .then(response => {
    ...
    const tituloBodyTemplate = (rowData) => {
      const nivelEstudios = rowData.nivel_estudios
        ? rowData.nivel_estudios.charAt(0).toUpperCase() + rowData.nivel_estudios.slice(1).toLowerCase()
        : 'No especificado';
    
      return (
        <div className="flex items-center">
          {/* Ícono SVG colorido representando un gorro de graduado */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="28"
            height="28"
            ...
            aria-hidden="true"
          >
            <path d="M14 3L2 9L14 15L26 9L14 3Z" fill="#4A90E2" />
            <path d="M7 11.5V18.5L14 22L21 18.5V11.5" stroke="#2C3E50" strokeWidth="2" />
            <path d="M14 15V22" stroke="#2C3E50" strokeWidth="2" />
            <rect x="12" y="22" width="4" height="3" fill="#2C3E50" />
            <path d="M26 9V16" stroke="#2C3E50" strokeWidth="2" />
            <path
          ...
          {/* Título con formato */}
          <span className="ml-3 text-gray-800 font-medium">{nivelEstudios}</span>
        </div>
      );
    };
          ...
          <div>
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              >
                ...
                <Column header="Título" body={tituloBodyTemplate} />
